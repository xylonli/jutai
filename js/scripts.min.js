if (function (t, e) {
    ...
    function i(t) {
        var e = !!t && "length" in t && t.length, i = ht.type(t);
    ...
    function l(t, e, i) {
        if (void 0 === i && 1 === t.nodeType) {
            ...
            if ("string" == typeof(i = t.getAttribute(n))) {
                try {
                    i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : Dt.test(i) ? ht.parseJSON(i) : i)
                } catch (t) {
                }
                ht.data(t, e, i)
            } else i = void 0
    ...
    function c(t, e, i, n) {
        if (Ot(t)) {
            ...
            if (u && l[u] && (n || l[u].data) || void 0 !== i || "string" != typeof e) return u || (u = a ? t[s] = et.pop() || ht.guid++ : s), l[u] || (l[u] = a ? {} : {toJSON: ht.noop}), "object" != typeof e && "function" != typeof e || (n ? l[u] = ht.extend(l[u], e) : l[u].data = ht.extend(l[u].data, e)), r = l[u], n || (r.data || (r.data = {}), r = r.data), void 0 !== i && (r[ht.camelCase(e)] = i), "string" == typeof e ? null == (o = r[e]) && (o = r[ht.camelCase(e)]) : o = r, o
        }
    }

    function d(t, e, i) {
        if (Ot(t)) {
            var n, o, r = t.nodeType, s = r ? ht.cache : t, a = r ? t[ht.expando] : ht.expando;
            if (s[a]) {
                if (e && (n = i ? s[a] : s[a].data)) {
                    ht.isArray(e) ? e = e.concat(ht.map(e, ht.camelCase)) : e in n ? e = [e] : (e = ht.camelCase(e), e = e in n ? [e] : e.split(" ")), o = e.length;
                    for (; o--;) delete n[e[o]];
                    if (i ? !u(n) : !ht.isEmptyObject(n)) return
                }
                (i || (delete s[a].data, u(s[a]))) && (r ? ht.cleanData([t], !0) : ct.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
            }
        }
    }
    ...
    function f(t, e) {
        ...
        if (!r) for (r = [], i = t.childNodes || t; null != (n = i[o]); o++) !e || ht.nodeName(n, e) ? r.push(n) : ht.merge(r, f(n, e));
    ...
    function v(t, e, i, n, o) {
        for (var r, s, a, l, u, c, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++) if ((s = t[w]) || 0 === s) if ("object" === ht.type(s)) ht.merge(y, s.nodeType ? [s] : s); else if (Bt.test(s)) {
            for (l = l || v.appendChild(e.createElement("div")), u = (Rt.exec(s) || ["", ""])[1].toLowerCase(), d = qt[u] || qt._default, l.innerHTML = d[1] + ht.htmlPrefilter(s) + d[2], r = d[0]; r--;) l = l.lastChild;
            if (!ct.leadingWhitespace && Wt.test(s) && y.push(e.createTextNode(Wt.exec(s)[0])), !ct.tbody) for (r = (s = "table" !== u || Ut.test(s) ? "<table>" !== d[1] || Ut.test(s) ? 0 : l : l.firstChild) && s.childNodes.length; r--;) ht.nodeName(c = s.childNodes[r], "tbody") && !c.childNodes.length && s.removeChild(c);
            for (ht.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(e.createTextNode(s));
        for (l && v.removeChild(l), ct.appendChecked || ht.grep(f(y, "input"), g), w = 0; s = y[w++];) if (n && ht.inArray(s, n) > -1) o && o.push(s); else if (a = ht.contains(s.ownerDocument, s), l = f(v.appendChild(s), "script"), a && m(l), i) for (r = 0; s = l[r++];) Ft.test(s.type || "") && i.push(s);
        return l = null, v
    }
    ...
    function E(t, e) {
        if (1 === e.nodeType && ht.hasData(t)) {
            var i, n, o, r = ht._data(t), s = ht._data(e, r), a = r.events;
            if (a) {
                delete s.handle, s.events = {};
                for (i in a) for (n = 0, o = a[i].length; o > n; n++) ht.event.add(e, i, a[i][n])
            }
    ...
    function S(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            "script" === i && e.text !== t.text ? (T(e).text = t.text, _(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), ct.html5Clone && t.innerHTML && !ht.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && jt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== i && "textarea" !== i || (e.defaultValue = t.defaultValue)
        }
    }

    function I(t, e, i, n) {
        e = ot.apply([], e);
        var o, r, s, a, l, u, c = 0, d = t.length, h = d - 1, p = e[0], m = ht.isFunction(p);
        if (m || d > 1 && "string" == typeof p && !ct.checkClone && ee.test(p)) return t.each(function (o) {
            var r = t.eq(o);
            m && (e[0] = p.call(this, o, r.html())), I(r, e, i, n)
        });
        if (d && (u = v(e, t[0].ownerDocument, !1, t, n), o = u.firstChild, 1 === u.childNodes.length && (u = o), o || n)) {
            for (s = (a = ht.map(f(u, "script"), T)).length; d > c; c++) r = u, c !== h && (r = ht.clone(r, !0, !0), s && ht.merge(a, f(r, "script"))), i.call(t[c], r, c);
            if (s) for (l = a[a.length - 1].ownerDocument, ht.map(a, _), c = 0; s > c; c++) r = a[c], Ft.test(r.type || "") && !ht._data(r, "globalEval") && ht.contains(l, r) && (r.src ? ht._evalUrl && ht._evalUrl(r.src) : ht.globalEval((r.text || r.textContent || r.innerHTML || "").replace(ne, "")));
            u = o = null
        }
        return t
    }
    ...
    function k(t, e, i) {
        for (var n, o = e ? ht.filter(e, t) : t, r = 0; null != (n = o[r]); r++) i || 1 !== n.nodeType || ht.cleanData(f(n)), n.parentNode && (i && ht.contains(n.ownerDocument, n) && m(f(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    ...
    function O(t) {
        var e = it, i = se[t];
        return i || ("none" !== (i = A(t, e)) && i || (re = (re || ht("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (re[0].contentWindow || re[0].contentDocument).document).write(), e.close(), i = A(t, e), re.detach()), se[t] = i), i
    }
    ...
    function L(t) {
        if (t in xe) return t;
        for (var e = t.charAt(0).toUpperCase() + t.slice(1), i = be.length; i--;) if ((t = be[i] + e) in xe) return t
    }

    function N(t, e) {
        for (var i, n, o, r = [], s = 0, a = t.length; a > s; s++) (n = t[s]).style && (r[s] = ht._data(n, "olddisplay"), i = n.style.display, e ? (r[s] || "none" !== i || (n.style.display = ""), "" === n.style.display && zt(n) && (r[s] = ht._data(n, "olddisplay", O(n.nodeName)))) : (o = zt(n), (i && "none" !== i || !o) && ht._data(n, "olddisplay", o ? i : ht.css(n, "display"))));
    ...
    function P(t, e, i, n, o) {
        for (var r = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === i && (s += ht.css(t, i + Pt[r], !0, o)), n ? ("content" === i && (s -= ht.css(t, "padding" + Pt[r], !0, o)), "margin" !== i && (s -= ht.css(t, "border" + Pt[r] + "Width", !0, o))) : (s += ht.css(t, "padding" + Pt[r], !0, o), "padding" !== i && (s += ht.css(t, "border" + Pt[r] + "Width", !0, o)));
        return s
    }

    function z(t, e, i) {
        var n = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = de(t),
    ...
    function F(t, e, i) {
        for (var n, o = (H.tweeners[e] || []).concat(H.tweeners["*"]), r = 0, s = o.length; s > r; r++) if (n = o[r].call(i, e, t)) return n
    }

    function W(t, e) {
        var i, n, o, r, s;
        for (i in t) if (n = ht.camelCase(i), o = e[n], r = t[i], ht.isArray(r) && (o = r[1], r = t[i] = r[0]), i !== n && (t[n] = r, delete t[i]), (s = ht.cssHooks[n]) && "expand" in s) {
    ...
    function H(t, e, i) {
        var n, o, r = 0, s = H.prefilters.length, a = ht.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (o) return !1;
            for (var e = Ce || j(), i = Math.max(0, u.startTime + u.duration - e), n = 1 - (i / u.duration || 0), r = 0, s = u.tweens.length; s > r; r++) u.tweens[r].run(n);
            return a.notifyWith(t, [u, n, i]), 1 > n && s ? i : (a.resolveWith(t, [u]), !1)
        }, u = a.promise({
            elem: t,
            props: ht.extend({}, e),
            opts: ht.extend(!0, {specialEasing: {}, easing: ht.easing._default}, i),
        ...
        for (W(c, u.opts.specialEasing); s > r; r++) if (n = H.prefilters[r].call(u, t, c, u.opts)) return ht.isFunction(n.stop) && (ht._queueHooks(u.elem, u.opts.queue).stop = ht.proxy(n.stop, n)), n;
    ...
    function B(t) {
        return function (e, i) {
            ...
            var n, o = 0, r = e.toLowerCase().match(It) || [];
            if (ht.isFunction(i)) for (; n = r[o++];) "+" === n.charAt(0) ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
        }
    }
    ...
    function G(t, e, i, n) {
        ...
        if (ht.isArray(e)) ht.each(e, function (e, o) {
            i || ti.test(t) ? n(t, o) : G(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, i, n)
        }); else if (i || "object" !== ht.type(e)) n(t, e); else for (o in e) G(t + "[" + o + "]", e[o], i, n)
    }
    ...
    var et = [], it = t.document, nt = et.slice, ot = et.concat, rt = et.push, st = et.indexOf, at = {},
        lt = at.toString, ut = at.hasOwnProperty, ct = {}, dt = "1.12.4", ht = function (t, e) {
            return new ht.fn.init(t, e)
        }, pt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ft = /^-ms-/, mt = /-([\da-z])/gi, gt = function (t, e) {
            return e.toUpperCase()
        };
    ht.fn = ht.prototype = {
        jquery: dt, constructor: ht, selector: "", length: 0, toArray: function () {
            return nt.call(this)
        }, get: function (t) {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || ht.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if (null != (o = arguments[a])) for (n in o) t = s[n], i = o[n], s !== i && (u && i && (ht.isPlainObject(i) || (e = ht.isArray(i))) ? (e ? (e = !1, r = t && ht.isArray(t) ? t : []) : r = t && ht.isPlainObject(t) ? t : {}, s[n] = ht.extend(u, r, i)) : void 0 !== i && (s[n] = i));
        return s
    }, ht.extend({
        expando: "jQuery" + (dt + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
            ...
            var n, o = 0;
            if (i(t)) for (n = t.length; n > o && !1 !== e.call(t[o], o, t[o]); o++) ; else for (o in t) if (!1 === e.call(t[o], o, t[o])) break;
            return t
        }, trim: function (t) {
            ...
            var o, r, s = 0, a = [];
            if (i(t)) for (o = t.length; o > s; s++) null != (r = e(t[s], s, n)) && a.push(r); else for (s in t) null != (r = e(t[s], s, n)) && a.push(r);
            return ot.apply([], a)
        }, guid: 1, proxy: function (t, e) {
            var i, n, o;
            return "string" == typeof e && (o = t[e], e = t, t = o), ht.isFunction(t) ? (i = nt.call(arguments, 2), n = function () {
                return t.apply(e || this, i.concat(nt.call(arguments)))
            }, n.guid = t.guid = t.guid || ht.guid++, n) : void 0
        }, now: function () {
            return +new Date
        }, support: ct
    }), "function" == typeof Symbol && (ht.fn[Symbol.iterator] = et[Symbol.iterator]), ht.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (t, e) {
        at["[object " + e + "]"] = e.toLowerCase()
    });
    var vt = function (t) {
        function e(t, e, i, n) {
            var o, r, s, a, u, d, h, p, f = e && e.ownerDocument, m = e ? e.nodeType : 9;
            if (i = i || [], "string" != typeof t || !t || 1 !== m && 9 !== m && 11 !== m) return i;
            if (!n && ((e ? e.ownerDocument || e : j) !== O && A(e), e = e || O, L)) {
                if (11 !== m && (d = mt.exec(t))) if (o = d[1]) {
                    if (9 === m) {
                        if (!(s = e.getElementById(o))) return i;
                        if (s.id === o) return i.push(s), i
                    } else if (f && (s = f.getElementById(o)) && z(e, s) && s.id === o) return i.push(s), i
                } else {
                    if (d[2]) return Y.apply(i, e.getElementsByTagName(t)), i;
                    if ((o = d[3]) && w.getElementsByClassName && e.getElementsByClassName) return Y.apply(i, e.getElementsByClassName(o)), i
                }
                if (w.qsa && !q[t + " "] && (!N || !N.test(t))) {
                    if (1 !== m) f = e, p = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = M), r = (h = T(t)).length, u = ct.test(a) ? "#" + a : "[id='" + a + "']"; r--;) h[r] = u + " " + c(h[r]);
        ...
        function d(t, e, i) {
            var n = e.dir, o = i && "parentNode" === n, r = F++;
            return e.first ? function (e, i, r) {
                ...
                if (s) {
                    ...
                    if (u = e[M] || (e[M] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (a = l[n]) && a[0] === R && a[1] === r) return c[2] = a[2];
        ...
        function m(t, e, i, o, r, s) {
            return o && !o[M] && (o = m(o)), r && !r[M] && (r = m(r, s)), n(function (n, s, a, l) {
                var u, c, d, h = [], m = [], g = s.length, v = n || p(e || "*", a.nodeType ? [a] : a, []),
                    y = !t || !n && e ? v : f(v, h, t, a, l), w = i ? r || (n ? t : g || o) ? [] : s : y;
                if (i && i(y, w, a, l), o) for (u = f(w, m), o(u, [], a, l), c = u.length; c--;) (d = u[c]) && (w[m[c]] = !(y[m[c]] = d));
                if (n) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (c = w.length; c--;) (d = w[c]) && (u = r ? K(n, d) : h[c]) > -1 && (n[u] = !(s[u] = d))
                    }
                } else w = f(w === s ? w.splice(g, w.length) : w), r ? r(null, s, w, l) : Y.apply(s, w)
            })
        }
        ...
        function g(t) {
            for (var e, i, n, o = t.length, r = b.relative[t[0].type], s = r || b.relative[" "], a = r ? 1 : 0, l = d(function (t) {
                ...
                return e = null, o
            }]; o > a; a++) if (i = b.relative[t[a].type]) p = [d(h(p), i)]; else {
                if ((i = b.filter[t[a].type].apply(null, t[a].matches))[M]) {
                    for (n = ++a; o > n && !b.relative[t[n].type]; n++) ;
                    return m(a > 1 && h(p), a > 1 && c(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(rt, "$1"), i, n > a && g(t.slice(a, n)), o > n && g(t = t.slice(n)), o > n && c(t))
                }
                p.push(i)
            }
            return h(p)
        ...
        function v(t, i) {
            var o = i.length > 0, r = t.length > 0, s = function (n, s, a, l, u) {
                var c, d, h, p = 0, m = "0", g = n && [], v = [], y = S, w = n || r && b.find.TAG("*", u),
                    x = R += null == y ? 1 : Math.random() || .1, C = w.length;
                for (u && (S = s === O || s || u); m !== C && null != (c = w[m]); m++) {
                    if (r && c) {
                        for (d = 0, s || c.ownerDocument === O || (A(c), a = !L); h = t[d++];) if (h(c, s || O, a)) {
                            l.push(c);
                            break
                        }
                        u && (R = x)
                ...
                if (p += m, o && m !== p) {
                    ...
                    if (n) {
                        if (p > 0) for (; m--;) g[m] || v[m] || (v[m] = X.call(l));
                        v = f(v)
                    }
        ...
        var y, w, b, x, C, T, _, E, S, I, k, A, O, D, L, N, $, P, z, M = "sizzle" + 1 * new Date, j = t.document, R = 0,
            F = 0, W = i(), H = i(), q = i(), B = function (t, e) {
                return t === e && (k = !0), 0
            }, U = 1 << 31, Z = {}.hasOwnProperty, Q = [], X = Q.pop, V = Q.push, Y = Q.push, G = Q.slice,
            K = function (t, e) {
            ...
            }, ht = /^(?:input|select|textarea|button)$/i, pt = /^h\d$/i, ft = /^[^{]+\{\s*\[native \w/,
            mt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, gt = /[+~]/, vt = /'|\\/g,
            yt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)", "ig"), wt = function (t, e, i) {
                var n = "0x" + e - 65536;
        ...
        w = e.support = {}, C = e.isXML = function (t) {
            ...
            return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, D = O.documentElement, L = !C(O), (i = O.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)), w.attributes = o(function (t) {
                return t.className = "i", !t.getAttribute("className")
            }), w.getElementsByTagName = o(function (t) {
                return t.appendChild(O.createComment("")), !t.getElementsByTagName("*").length
            }), w.getElementsByClassName = ft.test(O.getElementsByClassName), w.getById = o(function (t) {
                return D.appendChild(t).id = M, !O.getElementsByName || !O.getElementsByName(M).length
                ...
                D.appendChild(t).innerHTML = "<a id='" + M + "'></a><select id='" + M + "-\r\\' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && N.push("[*^$]=" + tt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || N.push("\\[" + tt + "*(?:value|" + J + ")"), t.querySelectorAll("[id~=" + M + "-]").length || N.push("~="), t.querySelectorAll(":checked").length || N.push(":checked"), t.querySelectorAll("a#" + M + "+*").length || N.push(".#.+[+~]")
            }), o(function (t) {
            ...
            })), (w.matchesSelector = ft.test(P = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function (t) {
                w.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), $.push("!=", nt)
            }), N = N.length && new RegExp(N.join("|")), $ = $.length && new RegExp($.join("|")), e = ft.test(D.compareDocumentPosition), z = e || ft.test(D.contains) ? function (t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === O || t.ownerDocument === j && z(j, t) ? -1 : e === O || e.ownerDocument === j && z(j, e) ? 1 : I ? K(I, t) - K(I, e) : 0 : 4 & i ? -1 : 1)
            } : function (t, e) {
                if (t === e) return k = !0, 0;
                var i, n = 0, o = t.parentNode, r = e.parentNode, a = [t], l = [e];
                if (!o || !r) return t === O ? -1 : e === O ? 1 : o ? -1 : r ? 1 : I ? K(I, t) - K(I, e) : 0;
                if (o === r) return s(t, e);
            ...
            if ((t.ownerDocument || t) !== O && A(t), i = i.replace(lt, "='$1']"), w.matchesSelector && L && !q[i + " "] && (!$ || !$.test(i)) && (!N || !N.test(i))) try {
                var n = P.call(t, i);
            ...
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === n && 0 === o ? function (t) {
                        ...
                        var u, c, d, h, p, f, m = r !== s ? "nextSibling" : "previousSibling", g = e.parentNode,
                        ...
                        if (g) {
                            ...
                            if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                for (w = (p = (u = (c = (d = (h = g)[M] || (h[M] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[t] || [])[0] === R && u[1]) && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (w = p = 0) || f.pop();) if (1 === h.nodeType && ++w && h === e) {
                                    c[t] = [R, p, w];
                                    break
                                }
                            } else if (y && (h = e, d = h[M] || (h[M] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[t] || [], p = u[0] === R && u[1], w = p), !1 === w) for (; (h = ++p && h && h[m] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[M] || (h[M] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[t] = [R, w]), h !== e));) ;
                            return (w -= o) === n || w % n == 0 && w / n >= 0
                        }
                    }
                }, PSEUDO: function (t, i) {
                    var o, r = b.pseudos[t] || b.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                    return r[M] ? r(i) : r.length > 1 ? (o = [t, t, "", i], b.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
            ...
            pseudos: {
                not: n(function (t) {
                    ...
                    return ct.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(yt, wt).toLowerCase(), function (e) {
                        var i;
                        do {
        ...
        for (y in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) b.pseudos[y] = function (t) {
            return function (e) {
                return "input" === e.nodeName.toLowerCase() && e.type === t
            }
        }(y);
        for (y in{submit: !0, reset: !0}) b.pseudos[y] = function (t) {
            return function (e) {
        ...
        return u.prototype = b.filters = b.pseudos, b.setFilters = new u, T = e.tokenize = function (t, i) {
            ...
            for (a = t, l = [], u = b.preFilter; a;) {
                ...
                for (s in b.filter) !(o = dt[s].exec(a)) || u[s] && !(o = u[s](o)) || (n = o.shift(), r.push({
                    value: n,
                    type: s,
                    matches: o
                }), a = a.slice(n.length));
            ...
            var o, r, s, a, u, d = "function" == typeof t && t, h = !n && T(t = d.selector || t);
            if (i = i || [], 1 === h.length) {
                if ((r = h[0] = h[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && L && b.relative[r[1].type]) {
                    if (!(e = (b.find.ID(s.matches[0].replace(yt, wt), e) || [])[0])) return i;
                    d && (e = e.parentNode), t = t.slice(r.shift().value.length)
                }
                for (o = dt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);) if ((u = b.find[a]) && (n = u(s.matches[0].replace(yt, wt), gt.test(r[0].type) && l(e.parentNode) || e))) {
                    if (r.splice(o, 1), !(t = n.length && c(r))) return Y.apply(i, n), i;
                    break
                }
            }
            return (d || _(t, h))(n, e, !L, i, !e || gt.test(t) && l(e.parentNode) || e), i
        }, w.sortStable = M.split("").sort(B).join("") === M, w.detectDuplicates = !!k, A(), w.sortDetached = o(function (t) {
    ...
    var yt = function (t, e, i) {
        ...
        return i
    }, bt = ht.expr.match.needsContext, xt = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Ct = /^.[^:#\[\.,]*$/;
    ht.filter = function (t, e, i) {
        ...
        find: function (t) {
            ...
            if ("string" != typeof t) return this.pushStack(ht(t).filter(function () {
                for (e = 0; o > e; e++) if (ht.contains(n[e], this)) return !0
            }));
            for (e = 0; o > e; e++) ht.find(t, n[e], i);
            return i = this.pushStack(o > 1 ? ht.unique(i) : i), i.selector = this.selector ? this.selector + " " + t : t, i
        }, filter: function (t) {
    ...
    (ht.fn.init = function (t, e, i) {
        ...
        if (i = i || Tt, "string" == typeof t) {
            ...
            if (n[1]) {
                if (e = e instanceof ht ? e[0] : e, ht.merge(this, ht.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : it, !0)), xt.test(n[1]) && ht.isPlainObject(e)) for (n in e) ht.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
        ...
        return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : ht.isFunction(t) ? void 0 !== i.ready ? i.ready(t) : t(ht) : (void 0 !== t.selector && (this.selector = t.selector, this.context = t.context), ht.makeArray(t, this))
    ...
    ht.fn.extend({
        has: function (t) {
            ...
            for (var i, n = 0, o = this.length, r = [], s = bt.test(t) || "string" != typeof t ? ht(t, e || this.context) : 0; o > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (s ? s.index(i) > -1 : 1 === i.nodeType && ht.find.matchesSelector(i, t))) {
                r.push(i);
                break
            }
        ...
        ht.fn[t] = function (i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = ht.filter(n, o)), this.length > 1 && (St[t] || (o = ht.uniqueSort(o)), Et.test(t) && (o = o.reverse())), this.pushStack(o)
        }
    });
    var It = /\S+/g;
    ht.Callbacks = function (t) {
        t = "string" == typeof t ? r(t) : ht.extend({}, t);
        var e, i, n, o, s = [], a = [], l = -1, u = function () {
            ...
            add: function () {
                return s && (i && !e && (l = s.length - 1, a.push(i)), function e(i) {
                    ht.each(i, function (i, n) {
                        ht.isFunction(n) ? t.unique && c.has(n) || s.push(n) : n && n.length && "string" !== ht.type(n) && e(n)
                    })
                }(arguments), i && !e && u()), this
            }, remove: function () {
                return ht.each(arguments, function (t, e) {
                    for (var i; (i = ht.inArray(e, s, i)) > -1;) s.splice(i, 1), l >= i && l--
                }), this
            }, has: function (t) {
        ...
        Deferred: function (t) {
                        ...
                        return ht.Deferred(function (i) {
                            ht.each(e, function (e, r) {
                                ...
                                o[r[1]](function () {
                                    ...
                                    t && ht.isFunction(t.promise) ? t.promise().progress(i.notify).done(i.resolve).fail(i.reject) : i[r[0] + "With"](this === n ? i.promise() : this, s ? [t] : arguments)
                                })
                            }), t = null
                        }).promise()
                    }, promise: function (t) {
            ...
            var e, i, n, o = 0, r = nt.call(arguments), s = r.length,
                a = 1 !== s || t && ht.isFunction(t.promise) ? s : 0, l = 1 === a ? t : ht.Deferred(),
                u = function (t, i, n) {
                    return function (o) {
                        i[t] = this, n[t] = arguments.length > 1 ? nt.call(arguments) : o, n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n)
                    }
                };
            if (s > 1) for (e = new Array(s), i = new Array(s), n = new Array(s); s > o; o++) r[o] && ht.isFunction(r[o].promise) ? r[o].promise().progress(u(o, i, e)).done(u(o, n, r)).fail(l.reject) : --a;
    ...
    ht.fn.ready = function (t) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (t) {
            ...
            (!0 === t ? --ht.readyWait : ht.isReady) || (ht.isReady = !0, !0 !== t && --ht.readyWait > 0 || (kt.resolveWith(it, [ht]), ht.fn.triggerHandler && (ht(it).triggerHandler("ready"), ht(it).off("ready"))))
        }
    }), ht.ready.promise = function (e) {
        if (!kt) if (kt = ht.Deferred(), "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll) t.setTimeout(ht.ready); else if (it.addEventListener) it.addEventListener("DOMContentLoaded", a), t.addEventListener("load", a); else {
    ...
    var Ot = function (t) {
        var e = ht.noData[(t.nodeName + " ").toLowerCase()], i = +t.nodeType || 1;
    ...
    ht.extend({
        ...
        data: function (t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = ht.data(r), 1 === r.nodeType && !ht._data(r, "parsedAttrs"))) {
                    for (i = s.length; i--;) s[i] && 0 === (n = s[i].name).indexOf("data-") && (n = ht.camelCase(n.slice(5)), l(r, n, o[n]));
        ...
        queue: function (t, e, i) {
            ...
            e = e || "fx";
            var i = ht.queue(t, e), n = i.length, o = i.shift(), r = ht._queueHooks(t, e);
        ...
        queue: function (t, e) {
            ...
            var i, n = 1, o = ht.Deferred(), r = this, s = this.length, a = function () {
                --n || o.resolveWith(r, [r])
            };
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) (i = ht._data(r[s], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
    ...
    var Nt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, $t = new RegExp("^(?:([+-])=|)(" + Nt + ")([a-z%]*)$", "i"),
        Pt = ["Top", "Right", "Bottom", "Left"], zt = function (t, e) {
            ...
            } else if (void 0 !== n && (o = !0, ht.isFunction(n) || (s = !0), u && (s ? (e.call(t, n), e = null) : (u = e, e = function (t, e, i) {
                return u.call(ht(t), i)
            })), e)) for (; l > a; a++) e(t[a], i, s ? n : n.call(t[a], a, e(t[a], i)));
            return o ? t : u ? e.call(t) : l ? e(t[0], i) : r
        }, jt = /^(?:checkbox|radio)$/i, Rt = /<([\w:-]+)/, Ft = /^$|\/(?:java|ecma)script/i, Wt = /^\s+/,
    ...
    var Zt = /^(?:input|select|textarea)$/i, Qt = /^key/, Xt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Vt = /^(?:focusinfocus|focusoutblur)$/, Yt = /^([^.]*)(?:\.(.+)|)/;
    ht.event = {
        global: {},
        add: function (t, e, i, n, o) {
            var r, s, a, l, u, c, d, h, p, f, m, g = ht._data(t);
            if (g) {
                for (i.handler && (l = i, i = l.handler, o = l.selector), i.guid || (i.guid = ht.guid++), (s = g.events) || (s = g.events = {}), (c = g.handle) || (c = g.handle = function (t) {
                    return void 0 === ht || t && ht.event.triggered === t.type ? void 0 : ht.event.dispatch.apply(c.elem, arguments)
                }, c.elem = t), a = (e = (e || "").match(It) || [""]).length; a--;) r = Yt.exec(e[a]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p && (u = ht.event.special[p] || {}, p = (o ? u.delegateType : u.bindType) || p, u = ht.event.special[p] || {}, d = ht.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, l), (h = s[p]) || (h = s[p] = [], h.delegateCount = 0, u.setup && !1 !== u.setup.call(t, n, f, c) || (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent("on" + p, c))), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), ht.event.global[p] = !0);
                t = null
            }
        },
        remove: function (t, e, i, n, o) {
            ...
            if (g && (c = g.events)) {
                for (u = (e = (e || "").match(It) || [""]).length; u--;) if (a = Yt.exec(e[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                    for (d = ht.event.special[p] || {}, h = c[p = (n ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = h.length; r--;) s = h[r], !o && m !== s.origType || i && i.guid !== s.guid || a && !a.test(s.namespace) || n && n !== s.selector && ("**" !== n || !s.selector) || (h.splice(r, 1), s.selector && h.delegateCount--, d.remove && d.remove.call(t, s));
                    l && !h.length && (d.teardown && !1 !== d.teardown.call(t, f, g.handle) || ht.removeEvent(t, p, g.handle), delete c[p])
                } else for (p in c) ht.event.remove(t, p + e[u], i, n, !0);
                ht.isEmptyObject(c) && (delete g.handle, ht._removeData(t, "events"))
            }
        },
        trigger: function (e, i, n, o) {
            var r, s, a, l, u, c, d, h = [n || it], p = ut.call(e, "type") ? e.type : e,
                f = ut.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = c = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !Vt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ht.makeArray(i, [e]), u = ht.event.special[p] || {}, o || !u.trigger || !1 !== u.trigger.apply(n, i))) {
                if (!o && !u.noBubble && !ht.isWindow(n)) {
                    for (l = u.delegateType || p, Vt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), c = a;
                    c === (n.ownerDocument || it) && h.push(c.defaultView || c.parentWindow || t)
                }
                for (d = 0; (a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : u.bindType || p, (r = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && r.apply(a, i), (r = s && a[s]) && r.apply && Ot(a) && (e.result = r.apply(a, i), !1 === e.result && e.preventDefault());
                if (e.type = p, !o && !e.isDefaultPrevented() && (!u._default || !1 === u._default.apply(h.pop(), i)) && Ot(n) && s && n[p] && !ht.isWindow(n)) {
        ...
        dispatch: function (t) {
            t = ht.event.fix(t);
            var e, i, n, o, r, s = [], a = nt.call(arguments), l = (ht._data(this, "events") || {})[t.type] || [],
        ...
        handlers: function (t, e) {
            ...
            if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
                for (n = [], i = 0; a > i; i++) r = e[i], o = r.selector + " ", void 0 === n[o] && (n[o] = r.needsContext ? ht(o, this).index(l) > -1 : ht.find(o, this, null, [l]).length), n[o] && n.push(r);
        ...
        fix: function (t) {
            ...
            for (s || (this.fixHooks[o] = s = Xt.test(o) ? this.mouseHooks : Qt.test(o) ? this.keyHooks : {}), n = s.props ? this.props.concat(s.props) : this.props, t = new ht.Event(r), e = n.length; e--;) i = n[e], t[i] = r[i];
        ...
        simulate: function (t, e, i) {
            var n = ht.extend(new ht.Event, i, {type: t, isSimulated: !0});
        ...
        return this instanceof ht.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? y : w) : this.type = t, e && ht.extend(this, e), this.timeStamp = t && t.timeStamp || ht.now(), void(this[ht.expando] = !0)) : new ht.Event(t, e)
    }, ht.Event.prototype = {
        ...
        ht.event.special[t] = {
            delegateType: e, bindType: e, handle: function (t) {
                ...
                return o && (o === n || ht.contains(n, o)) || (t.type = r.origType, i = r.handler.apply(this, arguments), t.type = e), i
            }
        }
        ...
        setup: function () {
            return !ht.nodeName(this, "form") && void ht.event.add(this, "click._submit keypress._submit", function (t) {
                var e = t.target, i = ht.nodeName(e, "input") || ht.nodeName(e, "button") ? ht.prop(e, "form") : void 0;
                i && !ht._data(i, "submit") && (ht.event.add(i, "submit._submit", function (t) {
                    t._submitBubble = !0
                }), ht._data(i, "submit", !0))
            })
        }, postDispatch: function (t) {
        ...
        setup: function () {
            return Zt.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (ht.event.add(this, "propertychange._change", function (t) {
                ...
                var e = t.target;
                Zt.test(e.nodeName) && !ht._data(e, "change") && (ht.event.add(e, "change._change", function (t) {
    ...
    }), ct.focusin || ht.each({focus: "focusin", blur: "focusout"}, function (t, e) {
        var i = function (t) {
            ht.event.simulate(e, t.target, ht.event.fix(t))
        };
        ht.event.special[e] = {
            setup: function () {
                var n = this.ownerDocument || this, o = ht._data(n, e);
                o || n.addEventListener(t, i, !0), ht._data(n, e, (o || 0) + 1)
            }, teardown: function () {
                var n = this.ownerDocument || this, o = ht._data(n, e) - 1;
    ...
    var Gt = / jQuery\d+="(?:null|\d+)"/g, Kt = new RegExp("<(?:" + Ht + ")[\\s/>]", "i"),
        Jt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, te = /<script|<style|<link/i,
        ee = /checked\s*(?:[^=]|=\s*.checked.)/i, ie = /^true\/(.*)/, ne = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
    ...
    ht.extend({
        htmlPrefilter: function (t) {
            ...
            if (ct.html5Clone || ht.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML, oe.removeChild(r = oe.firstChild)), !(ct.noCloneEvent && ct.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t))) for (n = f(r), a = f(t), s = 0; null != (o = a[s]); ++s) n[s] && S(o, n[s]);
            if (e) if (i) for (a = a || f(t), n = n || f(r), s = 0; null != (o = a[s]); s++) E(o, n[s]); else E(t, r);
            return (n = f(r, "script")).length > 0 && m(n, !l && f(t, "script")), n = a = o = null, r
        }, cleanData: function (t, e) {
            for (var i, n, o, r, s = 0, a = ht.expando, l = ht.cache, u = ct.attributes, c = ht.event.special; null != (i = t[s]); s++) if ((e || Ot(i)) && (o = i[a], r = o && l[o])) {
                if (r.events) for (n in r.events) c[n] ? ht.event.remove(i, n) : ht.removeEvent(i, n, r.handle);
                l[o] && (delete l[o], u || void 0 === i.removeAttribute ? i[a] = void 0 : i.removeAttribute(a), et.push(o))
            }
        }
    }), ht.fn.extend({
        domManip: I, detach: function (t) {
            return k(this, t, !0)
        }, remove: function (t) {
            return k(this, t)
        }, text: function (t) {
            ...
            return Mt(this, function (t) {
                ...
                if ("string" == typeof t && !te.test(t) && (ct.htmlSerialize || !Kt.test(t)) && (ct.leadingWhitespace || !Wt.test(t)) && !qt[(Rt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = ht.htmlPrefilter(t);
                    try {
                        for (; n > i; i++) 1 === (e = this[i] || {}).nodeType && (ht.cleanData(f(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {
                    }
                }
            ...
            return I(this, arguments, function (e) {
                ...
                ht.inArray(this, t) < 0 && (ht.cleanData(f(this)), i && i.replaceChild(e, this))
            }, t)
        }
    }), ht.each({
        appendTo: "append",
        ...
        ht.fn[t] = function (t) {
            for (var i, n = 0, o = [], r = ht(t), s = r.length - 1; s >= n; n++) i = n === s ? this : this.clone(!0), ht(r[n])[e](i), rt.apply(o, i.get());
            return this.pushStack(o)
        }
    });
    var re, se = {HTML: "block", BODY: "block"}, ae = /^margin/, le = new RegExp("^(" + Nt + ")(?!px)[a-z%]+$", "i"),
        ue = function (t, e, i, n) {
            var o, r, s = {};
    ...
    !function () {
        function e() {
            ...
            d.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", i = o = a = !1, n = s = !0, t.getComputedStyle && (c = t.getComputedStyle(u), i = "1%" !== (c || {}).top, a = "2px" === (c || {}).marginLeft, o = "4px" === (c || {width: "4px"}).width, u.style.marginRight = "50%", n = "4px" === (c || {marginRight: "4px"}).marginRight, e = u.appendChild(it.createElement("div")), e.style.cssText = u.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", e.style.marginRight = e.style.width = "0", u.style.width = "1px", s = !parseFloat((t.getComputedStyle(e) || {}).marginRight), u.removeChild(e)), u.style.display = "none", (r = 0 === u.getClientRects().length) && (u.style.display = "", u.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", u.childNodes[0].style.borderCollapse = "separate", e = u.getElementsByTagName("td"), e[0].style.cssText = "margin:0;border:0;padding:0;display:none", (r = 0 === e[0].offsetHeight) && (e[0].style.display = "", e[1].style.display = "none", r = 0 === e[0].offsetHeight)), d.removeChild(l)
        }

        var i, n, o, r, s, a, l = it.createElement("div"), u = it.createElement("div");
        u.style && (u.style.cssText = "float:left;opacity:.5", ct.opacity = "0.5" === u.style.opacity, ct.cssFloat = !!u.style.cssFloat, u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", ct.clearCloneStyle = "content-box" === u.style.backgroundClip, (l = it.createElement("div")).style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", u.innerHTML = "", l.appendChild(u), ct.boxSizing = "" === u.style.boxSizing || "" === u.style.MozBoxSizing || "" === u.style.WebkitBoxSizing, ht.extend(ct, {
    ...
    t.getComputedStyle ? (de = function (e) {
        ...
        return i = i || de(t), "" !== (s = i ? i.getPropertyValue(e) || i[e] : void 0) && void 0 !== s || ht.contains(t.ownerDocument, t) || (s = ht.style(t, e)), i && !ct.pixelMarginRight() && le.test(s) && ae.test(e) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r), void 0 === s ? s : s + ""
    }) : ce.currentStyle && (de = function (t) {
        return t.currentStyle
    }, he = function (t, e, i) {
        var n, o, r, s, a = t.style;
        return i = i || de(t), null == (s = i ? i[e] : void 0) && a && a[e] && (s = a[e]), le.test(s) && !pe.test(e) && (n = a.left, o = t.runtimeStyle, (r = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : s, s = a.pixelLeft + "px", a.left = n, r && (o.left = r)), void 0 === s ? s : s + "" || "auto"
    });
    var fe = /alpha\([^)]*\)/i, me = /opacity\s*=\s*([^)]*)/i, ge = /^(none|table(?!-c[ea]).+)/,
        ve = new RegExp("^(" + Nt + ")(.*)$", "i"), ye = {position: "absolute", visibility: "hidden", display: "block"},
        we = {letterSpacing: "0", fontWeight: "400"}, be = ["Webkit", "O", "Moz", "ms"],
    ...
    ht.extend({
        ...
        style: function (t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (e = ht.cssProps[a] || (ht.cssProps[a] = L(a) || a), s = ht.cssHooks[e] || ht.cssHooks[a], void 0 === i) return s && "get" in s && void 0 !== (o = s.get(t, !1, n)) ? o : l[e];
                if ("string" === (r = typeof i) && (o = $t.exec(i)) && o[1] && (i = h(t, e, o), r = "number"), null != i && i === i && ("number" === r && (i += o && o[3] || (ht.cssNumber[a] ? "" : "px")), ct.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(s && "set" in s && void 0 === (i = s.set(t, i, n))))) try {
                    l[e] = i
                } catch (t) {
                }
            }
        ...
        css: function (t, e, i, n) {
            ...
            return e = ht.cssProps[a] || (ht.cssProps[a] = L(a) || a), (s = ht.cssHooks[e] || ht.cssHooks[a]) && "get" in s && (r = s.get(t, !0, i)), void 0 === r && (r = he(t, e, n)), "normal" === r && e in we && (r = we[e]), "" === i || i ? (o = parseFloat(r), !0 === i || isFinite(o) ? o || 0 : r) : r
        }
    }), ht.each(["height", "width"], function (t, e) {
        ht.cssHooks[e] = {
            get: function (t, i, n) {
                return i ? ge.test(ht.css(t, "display")) && 0 === t.offsetWidth ? ue(t, ye, function () {
                    return z(t, e, n)
                }) : z(t, e, n) : void 0
            }, set: function (t, i, n) {
                var o = n && de(t);
                return $(0, i, n ? P(t, e, n, ct.boxSizing && "border-box" === ht.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        get: function (t, e) {
            ...
            var i = t.style, n = t.currentStyle, o = ht.isNumeric(e) ? "alpha(opacity=" + 100 * e + ")" : "",
                r = n && n.filter || i.filter || "";
            i.zoom = 1, (e >= 1 || "" === e) && "" === ht.trim(r.replace(fe, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === e || n && !n.filter) || (i.filter = fe.test(r) ? r.replace(fe, o) : r + " " + o)
        }
    }), ht.cssHooks.marginRight = D(ct.reliableMarginRight, function (t, e) {
        return e ? ue(t, {display: "inline-block"}, he, [t, "marginRight"]) : void 0
    }), ht.cssHooks.marginLeft = D(ct.reliableMarginLeft, function (t, e) {
        return e ? (parseFloat(he(t, "marginLeft")) || (ht.contains(t.ownerDocument, t) ? t.getBoundingClientRect().left - ue(t, {marginLeft: 0}, function () {
            return t.getBoundingClientRect().left
        }) : 0)) + "px" : void 0
    }), ht.each({margin: "", padding: "", border: "Width"}, function (t, e) {
        ht.cssHooks[t + e] = {
            expand: function (i) {
                for (var n = 0, o = {}, r = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) o[t + Pt[n] + e] = r[n] || r[n - 2] || r[0];
                return o
            }
        ...
        css: function (t, e) {
            return Mt(this, function (t, e, i) {
                var n, o, r = {}, s = 0;
                if (ht.isArray(e)) {
                    for (n = de(t), o = e.length; o > s; s++) r[e[s]] = ht.css(t, e[s], !1, n);
                    return r
                }
        ...
        constructor: M, init: function (t, e, i, n, o, r) {
            this.elem = t, this.prop = i, this.easing = o || ht.easing._default, this.options = e, this.start = this.now = this.cur(), this.end = n, this.unit = r || (ht.cssNumber[i] ? "" : "px")
        }, cur: function () {
            var t = M.propHooks[this.prop];
            return t && t.get ? t.get(this) : M.propHooks._default.get(this)
        }, run: function (t) {
            var e, i = M.propHooks[this.prop];
            return this.options.duration ? this.pos = e = ht.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : M.propHooks._default.set(this), this
        }
    ...
    var Ce, Te, _e = /^(?:toggle|show|hide)$/, Ee = /queueHooks$/;
    ht.Animation = ht.extend(H, {
        tweeners: {
            ...
            var n, o, r, s, a, l, u, c = this, d = {}, h = t.style, p = t.nodeType && zt(t), f = ht._data(t, "fxshow");
            i.queue || (null == (a = ht._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function () {
                a.unqueued || l()
            }), a.unqueued++, c.always(function () {
                c.always(function () {
                    a.unqueued--, ht.queue(t, "fx").length || a.empty.fire()
                })
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === ("none" === (u = ht.css(t, "display")) ? ht._data(t, "olddisplay") || O(t.nodeName) : u) && "none" === ht.css(t, "float") && (ct.inlineBlockNeedsLayout && "inline" !== O(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")), i.overflow && (h.overflow = "hidden", ct.shrinkWrapBlocks() || c.always(function () {
                h.overflow = i.overflow[0], h.overflowX = i.overflow[1], h.overflowY = i.overflow[2]
            }));
            for (n in e) if (o = e[n], _e.exec(o)) {
            ...
            if (ht.isEmptyObject(d)) "inline" === ("none" === u ? O(t.nodeName) : u) && (h.display = u); else {
                f ? "hidden" in f && (p = f.hidden) : f = ht._data(t, "fxshow", {}), r && (f.hidden = !p), p ? ht(t).show() : c.done(function () {
                    ht(t).hide()
                }), c.done(function () {
                    var e;
                ...
                for (n in d) s = F(p ? f[n] : 0, n, c), n in f || (f[n] = s.start, p && (s.end = s.start, s.start = "width" === n || "height" === n ? 1 : 0))
            }
        ...
        fadeTo: function (t, e, i, n) {
            ...
            var o = ht.isEmptyObject(t), r = ht.speed(e, i, n), s = function () {
            ...
            return "string" != typeof t && (i = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                ...
                if (o) s[o] && s[o].stop && n(s[o]); else for (o in s) s[o] && s[o].stop && Ee.test(o) && n(s[o]);
                for (o = r.length; o--;) r[o].elem !== this || null != t && r[o].queue !== t || (r[o].anim.stop(i), e = !1, r.splice(o, 1));
                !e && i || ht.dequeue(this, t)
            })
        }, finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, i = ht._data(this), n = i[t + "queue"], o = i[t + "queueHooks"], r = ht.timers,
                    s = n ? n.length : 0;
                for (i.finish = !0, ht.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--;) r[e].elem === this && r[e].queue === t && (r[e].anim.stop(!0), r.splice(e, 1));
    ...
    }, ht.fx.speeds = {slow: 600, fast: 200, _default: 400}, ht.fn.delay = function (e, i) {
    ...
    ht.fn.extend({
        val: function (t) {
            ...
            return arguments.length ? (n = ht.isFunction(t), this.each(function (i) {
                var o;
                1 === this.nodeType && (null == (o = n ? t.call(this, i, ht(this).val()) : t) ? o = "" : "number" == typeof o ? o += "" : ht.isArray(o) && (o = ht.map(o, function (t) {
                    return null == t ? "" : t + ""
                })), (e = ht.valHooks[this.type] || ht.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, o, "value") || (this.value = o))
            })) : o ? (e = ht.valHooks[o.type] || ht.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : "string" == typeof(i = o.value) ? i.replace(Se, "") : null == i ? "" : i : void 0
        }
    }), ht.extend({
        valHooks: {
            option: {
                ...
                get: function (t) {
                    for (var e, i, n = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : n.length, l = 0 > o ? a : r ? o : 0; a > l; l++) if (((i = n[l]).selected || l === o) && (ct.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !ht.nodeName(i.parentNode, "optgroup"))) {
                        if (e = ht(i).val(), r) return e;
                        s.push(e)
                    }
                    return s
                }, set: function (t, e) {
                    for (var i, n, o = t.options, r = ht.makeArray(e), s = o.length; s--;) if (n = o[s], ht.inArray(ht.valHooks.option.get(n), r) > -1) try {
                        n.selected = i = !0
                    } catch (t) {
                        n.scrollHeight
                    } else n.selected = !1;
    ...
    var ke, Ae, Oe = ht.expr.attrHandle, De = /^(?:checked|selected)$/i, Le = ct.getSetAttribute, Ne = ct.input;
    ht.fn.extend({
        attr: function (t, e) {
        ...
        attr: function (t, e, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? ht.prop(t, e, i) : (1 === r && ht.isXMLDoc(t) || (e = e.toLowerCase(), o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ae : ke)), void 0 !== i ? null === i ? void ht.removeAttr(t, e) : o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : o && "get" in o && null !== (n = o.get(t, e)) ? n : null == (n = ht.find.attr(t, e)) ? void 0 : n)
        }, attrHooks: {
            type: {
                set: function (t, e) {
            ...
            var i, n, o = 0, r = e && e.match(It);
            if (r && 1 === t.nodeType) for (; i = r[o++];) n = ht.propFix[i] || i, ht.expr.match.bool.test(i) ? Ne && Le || !De.test(i) ? t[n] = !1 : t[ht.camelCase("default-" + i)] = t[n] = !1 : ht.attr(t, i, ""), t.removeAttribute(Le ? i : n)
        }
    }), Ae = {
        set: function (t, e, i) {
            return !1 === e ? ht.removeAttr(t, i) : Ne && Le || !De.test(i) ? t.setAttribute(!Le && ht.propFix[i] || i, i) : t[ht.camelCase("default-" + i)] = t[i] = !0, i
        }
    ...
    var $e = /^(?:input|select|textarea|button|object)$/i, Pe = /^(?:a|area)$/i;
    ht.fn.extend({
        prop: function (t, e) {
        ...
        prop: function (t, e, i) {
            var n, o, r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && ht.isXMLDoc(t) || (e = ht.propFix[e] || e, o = ht.propHooks[e]), void 0 !== i ? o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : t[e] = i : o && "get" in o && null !== (n = o.get(t, e)) ? n : t[e]
        }, propHooks: {
            tabIndex: {
                get: function (t) {
    ...
    ht.fn.extend({
        addClass: function (t) {
            ...
            if ("string" == typeof t && t) for (e = t.match(It) || []; i = this[l++];) if (o = q(i), n = 1 === i.nodeType && (" " + o + " ").replace(ze, " ")) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function (i) {
                ...
                var e, n, o, r;
                if ("string" === i) for (n = 0, o = ht(this), r = t.match(It) || []; e = r[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== i || ((e = q(this)) && ht._data(this, "__className__", e), ht.attr(this, "class", e || !1 === t ? "" : ht._data(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++];) if (1 === i.nodeType && (" " + q(i) + " ").replace(ze, " ").indexOf(e) > -1) return !0;
            return !1
        }
    ...
    var Me = t.location, je = ht.now(), Re = /\?/,
        Fe = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
    ht.parseJSON = function (e) {
        if (t.JSON && t.JSON.parse) return t.JSON.parse(e + "");
        var i, n = null, o = ht.trim(e + "");
        ...
        return i && i.documentElement && !i.getElementsByTagName("parsererror").length || ht.error("Invalid XML: " + e), i
    };
    var We = /#.*$/, He = /([?&])_=[^&]*/, qe = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Be = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ue = /^(?:GET|HEAD)$/, Ze = /^\/\//,
        Qe = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Xe = {}, Ve = {}, Ye = "*/".concat("*"),
        Ge = Me.href, Ke = Qe.exec(Ge.toLowerCase()) || [];
    ht.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (e, i) {
            function n(e, i, n, o) {
                var r, d, y, w, x, T = i;
                2 !== b && (b = 2, l && t.clearTimeout(l), c = void 0, a = o || "", C.readyState = e > 0 ? 4 : 0, r = e >= 200 && 300 > e || 304 === e, n && (w = Q(h, C, n)), w = X(h, w, C, r), r ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (ht.lastModified[s] = x), (x = C.getResponseHeader("etag")) && (ht.etag[s] = x)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = w.state, d = w.data, y = w.error, r = !y)) : (y = T, !e && T || (T = "error", 0 > e && (e = 0))), C.status = e, C.statusText = (i || T) + "", r ? m.resolveWith(p, [d, T, C]) : m.rejectWith(p, [C, T, y]), C.statusCode(v), v = void 0, u && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, h, r ? d : y]), g.fireWith(p, [C, T]), u && (f.trigger("ajaxComplete", [C, h]), --ht.active || ht.event.trigger("ajaxStop")))
            }

            "object" == typeof e && (i = e, e = void 0), i = i || {};
            var o, r, s, a, l, u, c, d, h = ht.ajaxSetup({}, i), p = h.context || h,
                f = h.context && (p.nodeType || p.jquery) ? ht(p) : ht.event, m = ht.Deferred(),
                g = ht.Callbacks("once memory"), v = h.statusCode || {}, y = {}, w = {}, b = 0, x = "canceled", C = {
                    readyState: 0, getResponseHeader: function (t) {
                        var e;
                        if (2 === b) {
                            if (!d) for (d = {}; e = qe.exec(a);) d[e[1].toLowerCase()] = e[2];
                            e = d[t.toLowerCase()]
                        }
                        ...
                        var e;
                        if (t) if (2 > b) for (e in t) v[e] = [v[e], t[e]]; else C.always(t[C.status]);
                        return this
                    }, abort: function (t) {
                        var e = t || x;
        ...
        return ct.reliableHiddenOffsets() ? t.offsetWidth <= 0 && t.offsetHeight <= 0 && !t.getClientRects().length : Y(t)
    }, ht.expr.filters.visible = function (t) {
        return !ht.expr.filters.hidden(t)
    };
    var Je = /%20/g, ti = /\[\]$/, ei = /\r?\n/g, ii = /^(?:submit|button|image|reset|file)$/i,
        ni = /^(?:input|select|textarea|keygen)/i;
    ht.param = function (t, e) {
        var i, n = [], o = function (t, e) {
            e = ht.isFunction(e) ? e() : null == e ? "" : e, n[n.length] = encodeURIComponent(t) + "=" + encodeURIComponent(e)
        };
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !ht(this).is(":disabled") && ni.test(this.nodeName) && !ii.test(t) && (this.checked || !jt.test(t))
            }).map(function (t, e) {
                var i = ht(this).val();
                return null == i ? null : ht.isArray(i) ? ht.map(i, function (t) {
                    return {name: e.name, value: t.replace(ei, "\r\n")}
                }) : {name: e.name, value: i.replace(ei, "\r\n")}
            }).get()
        }
    }), ht.ajaxSettings.xhr = void 0 !== t.ActiveXObject ? function () {
        return this.isLocal ? J() : it.documentMode > 8 ? K() : /^(get|post|head|put|delete|options)$/i.test(this.type) && K() || J()
    } : K;
    var oi = 0, ri = {}, si = ht.ajaxSettings.xhr();
    t.attachEvent && t.attachEvent("onunload", function () {
            ...
            return {
                send: function (n, o) {
                    ...
                    s.send(e.hasContent && e.data || null), i = function (t, n) {
                        var r, l, u;
                        if (i && (n || 4 === s.readyState)) if (delete ri[a], i = void 0, s.onreadystatechange = ht.noop, n) 4 !== s.readyState && s.abort(); else {
                    ...
                    }, e.async ? 4 === s.readyState ? t.setTimeout(i) : s.onreadystatechange = ri[a] = i : i()
                }, abort: function () {
                    i && i(void 0, !0)
                }
            }
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function (n, o) {
                    (e = it.createElement("script")).async = !0, t.scriptCharset && (e.charset = t.scriptCharset), e.src = t.url, e.onload = e.onreadystatechange = function (t, i) {
    ...
    ht.ajaxSetup({
        ...
        var o, r, s,
            a = !1 !== e.jsonp && (li.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && li.test(e.data) && "data");
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = ht.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(li, "$1" + o) : !1 !== e.jsonp && (e.url += (Re.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return s || ht.error(o + " was not called"), s[0]
        }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
            s = arguments
        }, n.always(function () {
            void 0 === r ? ht(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = i.jsonpCallback, ai.push(o)), s && ht.isFunction(r) && r(s[0]), s = r = void 0
        }), "script") : void 0
    }), ht.parseHTML = function (t, e, i) {
        if (!t || "string" != typeof t) return null;
        "boolean" == typeof e && (i = e, e = !1), e = e || it;
        var n = xt.exec(t), o = !i && [];
        return n ? [e.createElement(n[1])] : (n = v([t], e, o), o && o.length && ht(o).remove(), ht.merge([], n.childNodes))
    };
    var ui = ht.fn.load;
    ht.fn.load = function (t, e, i) {
        if ("string" != typeof t && ui) return ui.apply(this, arguments);
        var n, o, r, s = this, a = t.indexOf(" ");
        return a > -1 && (n = ht.trim(t.slice(a, t.length)), t = t.slice(0, a)), ht.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (o = "POST"), s.length > 0 && ht.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function (t, e, i) {
            var n, o, r, s, a, l, u = ht.css(t, "position"), c = ht(t), d = {};
        ...
        offset: function (t) {
            ...
            return r ? (e = r.documentElement, ht.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (n = o.getBoundingClientRect()), i = tt(r), {
        ...
        ht.fn[t] = function (n) {
            return Mt(this, function (t, n, o) {
                var r = tt(t);
                return void 0 === o ? r ? e in r ? r[e] : r.document.documentElement[n] : t[n] : void(r ? r.scrollTo(i ? ht(r).scrollLeft() : o, i ? o : ht(r).scrollTop()) : t[n] = o)
        ...
        ht.each({padding: "inner" + t, content: e, "": "outer" + t}, function (i, n) {
            ht.fn[n] = function (n, o) {
                var r = arguments.length && (i || "boolean" != typeof n),
                    s = i || (!0 === n || !0 === o ? "margin" : "border");
                return Mt(this, function (e, i, n) {
                    var o;
                    return ht.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === n ? ht.css(e, i, s) : ht.style(e, i, n, s)
                }, e, r ? n : void 0, r, null)
            }
        })
    }), ht.fn.extend({
    ...
    o.prototype = {
        init: function () {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function () {
                var i, o, r, s, a, l, u, c, d, h = t(this), p = 0, f = 0, m = 0, g = 0;
                if (h.data("stellar-elementIsActive")) {
                    if (h.data("stellar-elementIsActive") !== this) return
                } else h.data("stellar-elementIsActive", this);
                e.options.showElement(h), h.data("stellar-startingLeft") ? (h.css("left", h.data("stellar-startingLeft")), h.css("top", h.data("stellar-startingTop"))) : (h.data("stellar-startingLeft", h.css("left")), h.data("stellar-startingTop", h.css("top"))), r = h.position().left, s = h.position().top, a = "auto" === h.css("margin-left") ? 0 : parseInt(h.css("margin-left"), 10), l = "auto" === h.css("margin-top") ? 0 : parseInt(h.css("margin-top"), 10), c = h.offset().left - a, d = h.offset().top - l, h.parents().each(function () {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (p = m, f = g, u = e, !1) : (m += e.position().left, void(g += e.position().top))
                }), i = h.data("stellar-horizontal-offset") !== n ? h.data("stellar-horizontal-offset") : u !== n && u.data("stellar-horizontal-offset") !== n ? u.data("stellar-horizontal-offset") : e.horizontalOffset, o = h.data("stellar-vertical-offset") !== n ? h.data("stellar-vertical-offset") : u !== n && u.data("stellar-vertical-offset") !== n ? u.data("stellar-vertical-offset") : e.verticalOffset, e.particles.push({
                    $element: h,
                    $offsetParent: u,
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function () {
                var e, s, a, l, u, c, p, f = t(this), m = h(f), g = 0, v = 0, y = 0, w = 0;
                if (f.data("stellar-backgroundIsActive")) {
                    if (f.data("stellar-backgroundIsActive") !== this) return
                } else f.data("stellar-backgroundIsActive", this);
                f.data("stellar-backgroundStartingLeft") ? d(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", m[0]), f.data("stellar-backgroundStartingTop", m[1])), a = "auto" === f.css("margin-left") ? 0 : parseInt(f.css("margin-left"), 10), l = "auto" === f.css("margin-top") ? 0 : parseInt(f.css("margin-top"), 10), u = f.offset().left - a - o, c = f.offset().top - l - r, f.parents().each(function () {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (g = y, v = w, p = e, !1) : (y += e.position().left, void(w += e.position().top))
            ...
            var t, e, i, n, o, r, s, a, l, u, c = this._getScrollLeft(), h = this._getScrollTop(), p = !0, f = !0;
    ...
    t.flexslider = function (i, n) {
        ...
        var r, s = o.vars.namespace, a = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            l = ("ontouchstart" in window || a || window.DocumentTouch && document instanceof DocumentTouch) && o.vars.touch,
            u = "click touchend MSPointerUp keyup", c = "", d = "vertical" === o.vars.direction, h = o.vars.reverse,
            p = o.vars.itemWidth > 0, f = "fade" === o.vars.animation, m = "" !== o.vars.asNavFor, g = {};
        t.data(i, "flexslider", o), g = {
            init: function () {
                ...
                setup: function () {
                    ...
                    var e, i, n = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging", r = 1;
                    if (o.controlNavScaffold = t('<ol class="' + s + "control-nav " + s + n + '"></ol>'), o.pagingCount > 1) for (var a = 0; a < o.pagingCount; a++) {
                        if (void 0 === (i = o.slides.eq(a)).attr("data-thumb-alt") && i.attr("data-thumb-alt", ""), altText = "" !== i.attr("data-thumb-alt") ? altText = ' alt="' + i.attr("data-thumb-alt") + '"' : "", e = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + r + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                            var l = i.attr("data-thumbcaption");
                            "" !== l && void 0 !== l && (e += '<span class="' + s + 'caption">' + l + "</span>")
                        }
                        o.controlNavScaffold.append("<li>" + e + "</li>"), r++
                    }
                    o.controlsContainer ? t(o.controlsContainer).append(o.controlNavScaffold) : o.append(o.controlNavScaffold), g.controlNav.set(), g.controlNav.active(), o.controlNavScaffold.delegate("a, img", u, function (e) {
                        if (e.preventDefault(), "" === c || c === e.type) {
                            var i = t(this), n = o.controlNav.index(i);
                    ...
                    o.controlNav = o.manualControls, g.controlNav.active(), o.controlNav.bind(u, function (e) {
                        if (e.preventDefault(), "" === c || c === e.type) {
                            var i = t(this), n = o.controlNav.index(i);
                ...
                setup: function () {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + s + "direction-nav li a", o)), g.directionNav.update(), o.directionNav.bind(u, function (e) {
                        e.preventDefault();
                        var i;
                        ("" === c || c === e.type) && (i = t(this).hasClass(s + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === c && (c = e.type), g.setToClearWatchedEvent()
                    })
                }, update: function () {
                    var t = s + "disabled";
                ...
                setup: function () {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + s + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + s + "pauseplay a", o)), g.pausePlay.update(o.vars.slideshow ? s + "pause" : s + "play"), o.pausePlay.bind(u, function (e) {
                        e.preventDefault(), ("" === c || c === e.type) && (t(this).hasClass(s + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === c && (c = e.type), g.setToClearWatchedEvent()
                    })
                }, update: function (t) {
                ...
                var t, e, n, r, s, l, u, c, m, g = !1, v = 0, y = 0, w = 0;
                a ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown", function (t) {
                    t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), i._gesture.addPointer(t.pointerId), w = 0, r = d ? o.h : o.w, l = Number(new Date), n = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * r : (o.currentSlide + o.cloneOffset) * r)
                }, !1), i._slider = o, i.addEventListener("MSGestureChange", function (t) {
                    t.stopPropagation();
                    var e = t.target._slider;
                    if (e) {
                        var o = -t.translationX, a = -t.translationY;
                        return w += d ? a : o, s = w, g = d ? Math.abs(w) < Math.abs(-o) : Math.abs(w) < Math.abs(-a), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            i._gesture.stop()
                        }) : void((!g || Number(new Date) - l > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (s = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / r + 2 : 1)), e.setProps(n + s, "setTouch"))))
                    }
                    ...
                    if (o) {
                        if (o.animatingTo === o.currentSlide && !g && null !== s) {
                            var a = h ? -s : s, u = a > 0 ? o.getTarget("next") : o.getTarget("prev");
                            o.canAdvance(u) && (Number(new Date) - l < 550 && Math.abs(a) > 50 || Math.abs(a) > r / 2) ? o.flexAnimate(u, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                    ...
                    (!(g = d ? Math.abs(s) < Math.abs(v - e) : Math.abs(s) < Math.abs(y - e)) || Number(new Date) - l > 500) && (i.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (s /= 0 === o.currentSlide && 0 > s || o.currentSlide === o.last && s > 0 ? Math.abs(s) / r + 2 : 1), o.setProps(n + s, "setTouch")))
                }, m = function (a) {
                    if (i.removeEventListener("touchmove", c, !1), o.animatingTo === o.currentSlide && !g && null !== s) {
                        var u = h ? -s : s, d = u > 0 ? o.getTarget("next") : o.getTarget("prev");
                        o.canAdvance(d) && (Number(new Date) - l < 550 && Math.abs(u) > 50 || Math.abs(u) > r / 2) ? o.flexAnimate(d, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                    }
                    i.removeEventListener("touchend", m, !1), t = null, e = null, s = null, n = null
                }, i.addEventListener("touchstart", u, !1))
            }, resize: function () {
                !o.animating && o.is(":visible") && (p || o.doMath(), f ? g.smoothHeight() : p ? (o.slides.width(o.computedW), o.update(o.pagingCount), o.setProps()) : d ? (o.viewport.height(o.h), o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && g.smoothHeight(), o.newSlides.width(o.computedW), o.setProps(o.computedW, "setTotal")))
                ...
                var i = t(o.vars.sync).data("flexslider"), n = o.animatingTo;
                switch (e) {
                    case"animate":
            ...
            if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), m && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, a) || n) && o.is(":visible")) {
                if (m && r) {
                    ...
                    if (o.atEnd = 0 === e || e === o.count - 1, u.flexAnimate(e, !0, !1, !0, a), o.direction = o.currentItem < e ? "next" : "prev", u.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e) return o.currentItem = e, o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), !1;
            ...
            var t = o.slides.first(), e = o.vars.itemMargin, i = o.vars.minItems, n = o.vars.maxItems;
            ...
            var n = t(e);
            o.count += 1, o.last = o.count - 1, d && h ? void 0 !== i ? o.slides.eq(o.count - i).after(n) : o.container.prepend(n) : void 0 !== i ? o.slides.eq(i).before(n) : o.container.append(n), o.update(i, "add"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.added(o)
        }, o.removeSlide = function (e) {
            var i = isNaN(e) ? o.slides.index(t(e)) : e;
            o.count -= 1, o.last = o.count - 1, isNaN(e) ? t(e, o.slides).remove() : d && h ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(), o.doMath(), o.update(i, "remove"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.removed(o)
        }, g.init()
    ...
    function o(o) {
        if (n(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
            ...
            for (var c = u.isBorderBox = "border-box" == s.boxSizing, d = 0; d < l; d++) {
                var h = a[d], p = s[h], f = parseFloat(p);
                u[h] = isNaN(f) ? 0 : f
            }
            var m = u.paddingLeft + u.paddingRight, g = u.paddingTop + u.paddingBottom,
                ...
                w = u.borderLeftWidth + u.borderRightWidth, b = u.borderTopWidth + u.borderBottomWidth, x = c && r,
                C = t(s.width);
            !1 !== C && (u.width = C + (x ? 0 : m + w));
            var T = t(s.height);
            return !1 !== T && (u.height = T + (x ? 0 : g + b)), u.innerWidth = u.width - (m + w), u.innerHeight = u.height - (g + b), u.outerWidth = u.width + v, u.outerHeight = u.height + y, u
        }
    }
    ...
    var h = function () {
        ...
        return function (e) {
            ...
            var i = u(e).split(" "), n = i[0], o = n.match(/^\[(.+)\]$/), r = t(o && o[1], n),
    ...
    e.DEFAULTS = {
        ...
        return this.each(function () {
            var n = t(this), o = n.data("countTo"), r = !o || "object" == typeof i, s = "object" == typeof i ? i : {},
                a = "string" == typeof i ? i : "start";
            r && (o && o.stop(), n.data("countTo", o = new e(this, s))), o[a].call(o)
        })
    }
}), function (t) {
    var e, i, n, o, r, s, a, l = "Close", u = "BeforeClose", c = "MarkupParse", d = "Open", h = "Change", p = "mfp",
        f = "." + p, m = "mfp-ready", g = "mfp-removing", v = "mfp-prevent-close", y = function () {
        }, w = !!window.jQuery, b = t(window), x = function (t, i) {
            e.ev.on(p + t + f, i)
        }, C = function (e, i, n, o) {
    ...
    y.prototype = {
        constructor: y, init: function () {
            ...
            if (!1 === i.isObj) {
                ...
                var a, l = i.items;
                for (r = 0; l.length > r; r++) if ((a = l[r]).parsed && (a = a.el[0]), a === i.el[0]) {
                    e.index = r;
                    break
                }
            } else e.items = t.isArray(i.items) ? i.items : [i.items], e.index = i.index || 0;
            {
                if (!e.isOpen) {
                    ...
                    return e.isIE7 && (y += " mfp-ie7"), y && e._addClassToMFP(y), e.updateItemHTML(), T("BuildControls"), t("html").css(g), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || n), e._lastFocusedEl = document.activeElement, setTimeout(function () {
            ...
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[i] ? e.content.find(".mfp-close").length || e.content.append(_()) : e.content = t : e.content = "", T("BeforeAppend"), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        }, parseEl: function (i) {
            var n, o = e.items[i];
            if (o.tagName ? o = {el: t(o)} : (n = o.type, o = {data: o, src: o.src}), o.el) {
                for (var r = e.types, s = 0; r.length > s; s++) if (o.el.hasClass("mfp-" + r[s])) {
                    n = r[s];
                    break
                }
            ...
            initInline: function () {
                ...
                if (D(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && (k || (I = o.hiddenClass, k = C(I), I = "mfp-" + I), A = r.after(k).detach().removeClass(I)), e.updateStatus("ready")
            ...
            initAjax: function () {
                ...
                var o = t.extend({
                    url: i.src, success: function (n, o, r) {
                        var s = {data: n, xhr: r};
                        T("ParseAjax", s), e.appendContent(t(s.data), N), i.finished = !0, $(), e._setFocus(), setTimeout(function () {
                            e.wrap.addClass(m)
    ...
    t.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                var o = 0, r = function () {
                    i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, T("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : s())
                }, s = function () {
                    i && (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("error", a.tError.replace("%url%", i.src))), i.hasSize = !0, i.loaded = !0, i.loadError = !0)
                }, a = e.st.image, l = n.find(".mfp-img");
                if (l.length) {
                    var u = document.createElement("img");
                    u.className = "mfp-img", i.img = t(u).on("load.mfploader", r).on("error.mfploader", s), u.src = i.src, l.is("img") && (i.img = i.img.clone()), (u = i.img[0]).naturalWidth > 0 ? i.hasSize = !0 : u.width || (i.hasSize = !1)
                }
    ...
    t.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                for (t = 1; (e.direction ? o : n) >= t; t++) e._preloadItem(e.index + t);
                for (t = 1; (e.direction ? n : o) >= t; t++) e._preloadItem(e.index - t)
            ...
            return t(this).each(function () {
                ...
                if (e) {
                    ...
                    s.on("touchstart" + n, function (t) {
                        c = !1, h = 1, d = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], l = d.clientX, u = d.clientY, b.on("touchmove" + n, function (t) {
                            d = t.originalEvent ? t.originalEvent.touches : t.touches, h = d.length, d = d[0], (Math.abs(d.clientX - l) > 10 || Math.abs(d.clientY - u) > 10) && (c = !0, i())
                        }).on("touchend" + n, function (t) {
                            i(), c || h > 1 || (r = !0, t.preventDefault(), clearTimeout(a), a = setTimeout(function () {
                                r = !1
                            }, 1e3), o())
                        })
                    })
    ...
    return function (t, e, i, n) {
        var o = {
            features: null, bind: function (t, e, i, n) {
                ...
                if (i.oldIE = document.all && !document.addEventListener, i.touch = "ontouchstart" in window, window.requestAnimationFrame && (i.raf = window.requestAnimationFrame, i.caf = window.cancelAnimationFrame), i.pointerEvent = navigator.pointerEnabled || navigator.msPointerEnabled, !i.pointerEvent) {
                    ...
                    var s = n.match(/Android\s([0-9\.]*)/), a = s ? s[1] : 0;
                ...
                for (var l, u, c = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], h = 0; h < 4; h++) {
                    e = d[h];
                    for (var p = 0; p < 3; p++) l = c[p], u = e + (e ? l.charAt(0).toUpperCase() + l.slice(1) : l), !i[l] && u in t && (i[l] = u);
        ...
        o.detectFeatures(), o.features.oldIE && (o.bind = function (t, e, i, n) {
            e = e.split(" ");
            for (var o, r = (n ? "detach" : "attach") + "Event", s = 0; s < e.length; s++) if (o = e[s]) if ("object" == typeof i && i.handleEvent) {
                if (n) {
        ...
        o.extend(s, n);
        var a, l, u, c, d, h, p, f, m, g, v, y, w, b, x, C, T, _, E, S, I, k, A, O, D, L, N, $, P, z, M, j, R, F, W, H,
            q, B, U, Z, Q, X, V, Y, G, K, J, tt, et, it, nt, ot, rt, st, at, lt, ut, ct = {x: 0, y: 0},
            dt = {x: 0, y: 0}, ht = {x: 0, y: 0}, pt = {}, ft = 0, mt = {}, gt = {x: 0, y: 0}, vt = 0, yt = !0, wt = [],
            bt = {}, xt = !1, Ct = function (t, e) {
                ...
                (!xt || o && o !== r.currItem) && (n /= o ? o.fitRatio : r.currItem.fitRatio), t[k] = y + e + "px, " + i + "px" + w + " scale(" + n + ")"
            }, Ot = function (t) {
                it && (t && (g > r.currItem.fitRatio ? xt || (si(r.currItem, !1, !0), xt = !0) : xt && (si(r.currItem), xt = !1)), At(it, ht.x, ht.y, g))
            }, Dt = function (t) {
                ...
                if (!s.loop && e) {
                    var i = c + (gt.x * ft - t) / gt.x, n = Math.round(t - fe.x);
                ...
                Mt && (o.unbind(document, "mousemove", jt), o.addClass(t, "pswp--has_mouse"), s.mouseUsed = !0, St("mouseUsed")), Mt = setTimeout(function () {
                    Mt = null
                }, 100)
            }, Rt = function () {
                o.bind(document, "keydown", r), M.transform && o.bind(r.scrollWrap, "click", r), s.mouseUsed || o.bind(document, "mousemove", jt), o.bind(window, "resize scroll orientationchange", r), St("bindEvents")
            }, Ft = function () {
                o.unbind(window, "resize scroll orientationchange", r), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", jt), M.transform && o.unbind(r.scrollWrap, "click", r), U && o.unbind(window, p, r), clearTimeout(j), St("unbindEvents")
            }, Wt = function (t, e) {
                ...
                return n === r.currItem.initialZoomLevel ? (i[t] = r.currItem.initialPosition[t], !0) : (i[t] = $t(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
            }, Ut = function () {
                if (k) {
                ...
                k = "left", o.addClass(t, "pswp--ie"), Lt = function (t, e) {
                    ...
                    if (it) {
                        var t = it, e = r.currItem, i = e.fitRatio > 1 ? 1 : e.fitRatio, n = i * e.w, o = i * e.h;
                        t.width = n + "px", t.height = o + "px", t.left = ht.x + "px", t.top = ht.y + "px"
                    }
                }
            }, Zt = function (t) {
                var e = "";
                ...
                shout: St, listen: Et, viewportSize: pt, options: s, isMainScrollAnimating: function () {
                    return nt
                    ...
                    if (!a && !l) {
                        var i;
                        r.framework = o, r.template = t, r.bg = o.getChildByClass(t, "pswp__bg"), N = t.className, a = !0, M = o.detectFeatures(), D = M.raf, L = M.caf, k = M.transform, P = M.oldIE, r.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), r.container = o.getChildByClass(r.scrollWrap, "pswp__container"), d = r.container.style, r.itemHolders = C = [{
                        ...
                        for (M.animationName && M.transform && !n || (s.showAnimationDuration = s.hideAnimationDuration = 0), i = 0; i < wt.length; i++) r["init" + wt[i]]();
                        e && (r.ui = new e(r, o)).init(), St("firstUpdate"), c = c || s.index || 0, (isNaN(c) || c < 0 || c >= Ve()) && (c = 0), r.currItem = Xe(c), (M.isOldIOSPhone || M.isOldAndroid) && (yt = !1), t.setAttribute("aria-hidden", "false"), s.modal && (yt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === z && (St("initialLayout"), z = $ = o.getScrollY());
                        var u = "pswp--open ";
                        for (s.mainClass && (u += s.mainClass + " "), s.showHideOpacity && (u += "pswp--animate_opacity "), u += O ? "pswp--touch" : "pswp--notouch", u += M.animationName ? " pswp--css_animation" : "", u += M.svg ? " pswp--svg" : "", o.addClass(t, u), r.updateSize(), h = -1, vt = null, i = 0; i < 3; i++) Lt((i + h) * gt.x, C[i].el.style);
                        P || o.bind(r.scrollWrap, f, r), Et("initialZoomInEnd", function () {
                            r.setContent(C[0], c - 1), r.setContent(C[2], c + 1), C[0].el.style.display = C[2].el.style.display = "block", s.focus && t.focus(), Rt()
                        }), r.setContent(C[1], c), r.updateCurrItem(), St("afterInit"), yt || (b = setInterval(function () {
                    ...
                    St("destroy"), Be && clearTimeout(Be), t.setAttribute("aria-hidden", "true"), t.className = N, b && clearInterval(b), o.unbind(r.scrollWrap, f, r), o.unbind(window, "scroll", r), be(), Jt(), _t = null
                }, panTo: function (t, e, i) {
                    i || (t > et.min.x ? t = et.min.x : t < et.max.x && (t = et.max.x), e > et.min.y ? e = et.min.y : e < et.max.y && (e = et.max.y)), ht.x = t, ht.y = e, Ot()
                    ...
                    et = r.currItem.bounds, v = g = r.currItem.initialZoomLevel, ht.x = et.center.x, ht.y = et.center.y, t && St("afterChange")
                    ...
                    if (0 !== vt) {
                        var e, i = Math.abs(vt);
                        if (!(t && i < 2)) {
                            r.currItem = Xe(c), xt = !1, St("beforeChange", vt), i >= 3 && (h += vt + (vt > 0 ? -3 : 3), i = 3);
                            for (var n = 0; n < i; n++) vt > 0 ? (e = C.shift(), C[2] = e, h++, Lt((h + 2) * gt.x, e.el.style), r.setContent(e, c - i + n + 1 + 1)) : (e = C.pop(), C.unshift(e), h--, Lt(h * gt.x, e.el.style), r.setContent(e, c + i - n - 1 - 1));
                            if (it && 1 === Math.abs(vt)) {
                                var o = Xe(T);
                    ...
                    if (!yt && s.modal) {
                        var i = o.getScrollY();
                        if (z !== i && (t.style.top = i + "px", z = i), !e && bt.x === window.innerWidth && bt.y === window.innerHeight) return;
                        bt.x = window.innerWidth, bt.y = window.innerHeight, t.style.height = bt.y + "px"
                    }
                    if (pt.x = r.scrollWrap.clientWidth, pt.y = r.scrollWrap.clientHeight, Xt(), gt.x = pt.x + Math.round(pt.x * s.spacing), gt.y = pt.y, Nt(gt.x * ft), St("beforeResize"), void 0 !== h) {
                        for (var n, a, l, u = 0; u < 3; u++) n = C[u], Lt((u + h) * gt.x, n.el.style), l = c + u - 1, s.loop && Ve() > 2 && (l = Tt(l)), (a = Xe(l)) && (x || a.needsUpdate || !a.bounds) ? (r.cleanSlide(a), r.setContent(n, l), 1 === u && (r.currItem = a, r.updateCurrZoomItem(!0)), a.needsUpdate = !1) : -1 === n.index && l >= 0 && r.setContent(n, l), a && a.container && (ii(a, pt), si(a), Dt(a));
                        x = !1
                    }
                    v = g = r.currItem.initialZoomLevel, (et = r.currItem.bounds) && (ht.x = et.center.x, ht.y = et.center.y, Ot(!0)), St("resize")
                }, zoomTo: function (t, e, i, n, r) {
                    e && (v = g, me.x = Math.abs(e.x) - ht.x, me.y = Math.abs(e.y) - ht.y, Pt(dt, ht));
                    var s = Wt(t, !1), a = {};
                    Bt("x", s, a, t), Bt("y", s, a, t);
                    var l = g, u = {x: ht.x, y: ht.y};
                    zt(a);
                    var c = function (e) {
                        1 === e ? (g = t, ht.x = a.x, ht.y = a.y) : (g = (t - l) * e + l, ht.x = (a.x - u.x) * e + u.x, ht.y = (a.y - u.y) * e + u.y), r && r(e), Ot(1 === e)
                    };
                    i ? te("customZoomTo", 0, 1, i, n || o.easing.sine.inOut, c) : c(1)
                }
            }, ie = {}, ne = {}, oe = {}, re = {}, se = {}, ae = [], le = {}, ue = [], ce = {}, de = 0, he = {x: 0, y: 0},
            pe = 0, fe = {x: 0, y: 0}, me = {x: 0, y: 0}, ge = {x: 0, y: 0}, ve = function (t, e) {
                ...
                return _e.prevent = !Te(t.target, s.isClickableElement), St("preventDragEvent", t, e, _e), _e.prevent
            }, Se = function (t, e) {
            ...
            }, Oe = {}, De = {}, Le = [], Ne = function (t) {
                for (; Le.length > 0;) Le.pop();
                return A ? (ut = 0, ae.forEach(function (t) {
                    0 === ut ? Le[0] = t : 1 === ut && (Le[1] = t), ut++
                })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Le[0] = Se(t.touches[0], Oe), t.touches.length > 1 && (Le[1] = Se(t.touches[1], De))) : (Oe.x = t.pageX, Oe.y = t.pageY, Oe.id = "", Le[0] = Oe), Le
            }, $e = function (t, e) {
                var i, n, o, a, l = ht[t] + e[t], u = e[t] > 0, c = fe.x + e.x, d = fe.x - le.x;
                return i = l > et.min[t] || l < et.max[t] ? s.panEndFriction : 1, l = ht[t] + e[t] * i, !s.allowPanToNext && g !== r.currItem.initialZoomLevel || (it ? "h" !== ot || "x" !== t || Q || (u ? (l > et.min[t] && (i = s.panEndFriction, et.min[t], n = et.min[t] - dt[t]), (n <= 0 || d < 0) && Ve() > 1 ? (a = c, d < 0 && c > le.x && (a = le.x)) : et.min.x !== et.max.x && (o = l)) : (l < et.max[t] && (i = s.panEndFriction, et.max[t], n = dt[t] - et.max[t]), (n <= 0 || d > 0) && Ve() > 1 ? (a = c, d > 0 && c < le.x && (a = le.x)) : et.min.x !== et.max.x && (o = l))) : a = c, "x" !== t) ? void(nt || Y || g > r.currItem.fitRatio && (ht[t] += e[t] * i)) : (void 0 !== a && (Nt(a, !0), Y = a !== le.x), et.min.x !== et.max.x && (void 0 !== o ? ht.x = o : Y || (ht.x += e.x * i)), void 0 !== a)
            }, Pe = function (t) {
                if (!("mousedown" === t.type && t.button > 0)) {
                    ...
                    if (!B || "mousedown" !== t.type) {
                        if (Ee(t, !0) && t.preventDefault(), St("pointerDown"), A) {
                            ...
                            e < 0 && (e = ae.length), ae[e] = {x: t.pageX, y: t.pageY, id: t.pointerId}
                        }
                        var i = Ne(t), n = i.length;
                        G = null, Jt(), U && 1 !== n || (U = rt = !0, o.bind(window, p, r), H = lt = st = q = Y = X = Z = Q = !1, ot = null, St("firstTouchStart", i), Pt(dt, ht), ct.x = ct.y = 0, Pt(re, i[0]), Pt(se, re), le.x = gt.x * ft, ue = [{
                            x: re.x,
                            y: re.y
                        }], F = R = It(), Wt(g, !0), be(), xe()), !K && n > 1 && !nt && !Y && (v = g, Q = !1, K = Z = !0, ct.y = ct.x = 0, Pt(dt, ht), Pt(ie, i[0]), Pt(ne, i[1]), Ie(ie, ne, ge), me.x = Math.abs(ge.x) - ht.x, me.y = Math.abs(ge.y) - ht.y, J = tt = we(ie, ne))
                    }
                }
            }, ze = function (t) {
                ...
                if (U) {
                    var n = Ne(t);
                    if (ot || X || K) G = n; else if (fe.x !== gt.x * ft) ot = "h"; else {
                ...
                if (G) {
                    var t = G.length;
                    if (0 !== t) if (Pt(ie, G[0]), oe.x = ie.x - re.x, oe.y = ie.y - re.y, K && t > 1) {
                        if (re.x = ie.x, re.y = ie.y, !oe.x && !oe.y && ve(G[1], ne)) return;
                        Pt(ne, G[1]), Q || (Q = !0, St("zoomGestureStarted"));
                        var e = we(ie, ne), i = He(e);
                        i > r.currItem.initialZoomLevel + r.currItem.initialZoomLevel / 15 && (lt = !0);
                        var n = 1, o = Ht(), a = qt();
                        if (i < o) if (s.pinchToClose && !lt && v <= r.currItem.initialZoomLevel) {
                            var l = 1 - (o - i) / (o / 1.2);
                            kt(l), St("onPinchClose", l), st = !0
                        } else (n = (o - i) / o) > 1 && (n = 1), i = o - n * (o / 3); else i > a && ((n = (i - a) / (6 * o)) > 1 && (n = 1), i = a + n * o);
                        n < 0 && (n = 0), J = e, Ie(ie, ne, he), ct.x += he.x - ge.x, ct.y += he.y - ge.y, Pt(ge, he), ht.x = $t("x", i), ht.y = $t("y", i), H = i > g, g = i, Ot()
                    } else {
                        if (!ot) return;
                        if (rt && (rt = !1, Math.abs(oe.x) >= 10 && (oe.x -= G[0].x - se.x), Math.abs(oe.y) >= 10 && (oe.y -= G[0].y - se.y)), re.x = ie.x, re.y = ie.y, 0 === oe.x && 0 === oe.y) return;
                        if ("v" === ot && s.closeOnVerticalDrag && !Ce()) {
                            ct.y += oe.y, ht.y += oe.y;
                            var u = Ae();
                            return q = !0, St("onVerticalDrag", u), kt(u), void Ot()
                        }
                        ke(It(), ie.x, ie.y), X = !0, et = r.currItem.bounds, $e("x", oe) || ($e("y", oe), zt(ht), Ot())
                    }
                }
            }, je = function (t) {
                if (M.isOldAndroid) {
                ...
                if (A) {
                    ...
                    if (i > -1) if (e = ae.splice(i, 1)[0], navigator.pointerEnabled) e.type = t.pointerType || "mouse"; else {
                        var n = {4: "mouse", 2: "touch", 3: "pen"};
                        e.type = n[t.pointerType], e.type || (e.type = t.pointerType || "mouse")
                    }
                }
                var a, l = Ne(t), u = l.length;
                ...
                var c = -1;
                if (0 === u && (U = !1, o.unbind(window, p, r), be(), K ? c = 0 : -1 !== pe && (c = It() - pe)), pe = 1 === u ? It() : -1, a = -1 !== c && c < 150 ? "zoom" : "swipe", K && u < 2 && (K = !1, 1 === u && (a = "zoomPointerUp"), St("zoomGestureEnded")), G = null, X || Q || nt || q) if (Jt(), W || (W = Re()), W.calculateSwipeSpeed("x"), q) if (Ae() < s.verticalDragRange) r.close(); else {
                    var d = ht.y, h = at;
                    te("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                        ht.y = (r.currItem.initialPosition.y - d) * t + d, kt((1 - h) * t + h), Ot()
                    }), St("onVerticalDrag", 1)
                } else {
                    if ((Y || nt) && 0 === u) {
                        if (We(a, W)) return;
                ...
                var t, e, i = {
                    ...
                    panAnimLoop: function () {
                        if (Vt.zoomPan && (Vt.zoomPan.raf = D(i.panAnimLoop), i.now = It(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), Ot(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05)) return ht.x = Math.round(ht.x), ht.y = Math.round(ht.y), Ot(), void Gt("zoomPan")
                    }
                };
                return i
            }, Fe = function (t) {
                return t.calculateSwipeSpeed("y"), et = r.currItem.bounds, t.backAnimDestination = {}, t.backAnimStarted = {}, Math.abs(t.lastFlickSpeed.x) <= .05 && Math.abs(t.lastFlickSpeed.y) <= .05 ? (t.speedDecelerationRatioAbs.x = t.speedDecelerationRatioAbs.y = 0, t.calculateOverBoundsAnimOffset("x"), t.calculateOverBoundsAnimOffset("y"), !0) : (Kt("zoomPan"), t.lastNow = It(), void t.panAnimLoop())
            }, We = function (t, e) {
                var i;
                nt || (de = c);
                var n;
                if ("swipe" === t) {
                    var a = re.x - se.x, l = e.lastFlickDist.x < 10;
                    a > 30 && (l || e.lastFlickOffset.x > 20) ? n = -1 : a < -30 && (l || e.lastFlickOffset.x < -20) && (n = 1)
                }
                var u;
                n && ((c += n) < 0 ? (c = s.loop ? Ve() - 1 : 0, u = !0) : c >= Ve() && (c = s.loop ? 0 : Ve() - 1, u = !0), u && !s.loop || (vt += n, ft -= n, i = !0));
                var d, h = gt.x * ft, p = Math.abs(h - fe.x);
                return i || h > fe.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, de === c && (i = !1), nt = !0, St("mainScrollAnimStart"), te("mainScroll", fe.x, h, d, o.easing.cubic.out, Nt, function () {
                    Jt(), nt = !1, de = -1, (i || de !== c) && r.updateCurrItem(), St("mainScrollAnimComplete")
        ...
        var Be, Ue, Ze, Qe, Xe, Ve, Ye, Ge = function (e, i, n, a) {
            ...
            var d = n ? s.hideAnimationDuration : s.showAnimationDuration, h = function () {
                Gt("initialZoom"), n ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (kt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), a && a(), Qe = !1
            };
            if (!d || !l || void 0 === l.x) return St("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Pt(ht, e.initialPosition), Ot(), t.style.opacity = n ? 0 : 1, kt(1), void(d ? setTimeout(function () {
                h()
            }, d) : h());
            !function () {
                var i = u, a = !r.currItem.src || r.currItem.loadError || s.showHideOpacity;
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ht.x = l.x, ht.y = l.y - $, r[a ? "template" : "bg"].style.opacity = .001, Ot()), Kt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), a && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                    o.addClass(t, "pswp--animate_opacity")
                }, 30)), Be = setTimeout(function () {
                    if (St("initialZoom" + (n ? "Out" : "In")), n) {
                        var r = l.w / e.w, s = {x: ht.x, y: ht.y}, u = g, c = at, p = function (e) {
                            1 === e ? (g = r, ht.x = l.x, ht.y = l.y - z) : (g = (r - u) * e + u, ht.x = (l.x - s.x) * e + s.x, ht.y = (l.y - z - s.y) * e + s.y), Ot(), a ? t.style.opacity = 1 - e : kt(c - e * c)
                        };
                        i ? te("initialZoom", 0, 1, d, o.easing.cubic.out, p, h) : (p(1), Be = setTimeout(h, d + 20))
                    } else g = e.initialZoomLevel, Pt(ht, e.initialPosition), Ot(), kt(1), a ? t.style.opacity = 1 : kt(1), Be = setTimeout(h, d + 20)
                }, n ? 25 : 90)
            }()
        }, Ke = {}, Je = [], ti = {
            index: 0,
            ...
            var n = t.bounds;
            n.center.x = Math.round((Ke.x - e) / 2), n.center.y = Math.round((Ke.y - i) / 2) + t.vGap.top, n.max.x = e > Ke.x ? Math.round(Ke.x - e) : n.center.x, n.max.y = i > Ke.y ? Math.round(Ke.y - i) + t.vGap.top : n.center.y, n.min.x = e > Ke.x ? 0 : n.center.x, n.min.y = i > Ke.y ? t.vGap.top : n.center.y
        }, ii = function (t, e, i) {
            if (t.src && !t.loadError) {
                ...
                if (n && (t.vGap || (t.vGap = {
                    top: 0,
                    bottom: 0
                }), St("parseVerticalMargin", t)), Ke.x = e.x, Ke.y = e.y - t.vGap.top - t.vGap.bottom, n) {
                ...
                if (!i) return;
                return ei(t, t.w * i, t.h * i), n && i === t.initialZoomLevel && (t.initialPosition = t.bounds.center), t.bounds
            }
            ...
            e.loadError || n && (e.imageAppended = !0, si(e, n, e === r.currItem && xt), i.appendChild(n), s && setTimeout(function () {
            ...
            if (Je.length) {
                for (var t, e = 0; e < Je.length; e++) (t = Je[e]).holder.index === t.index && ni(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                Je = []
            }
        };
        Ct("Controller", {
            publicMethods: {
                lazyLoadItem: function (t) {
                    t = Tt(t);
                    var e = Xe(t);
                    e && (!e.loaded && !e.loading || x) && (St("gettingData", t, e), e.src && oi(e))
                }, initController: function () {
                    o.extend(s, ti, !0), r.items = Ue = i, Xe = r.getItemAt, Ve = s.getNumItemsFn, Ye = s.loop, Ve() < 3 && (s.loop = !1), Et("beforeChange", function (t) {
                        var e, i = s.preload, n = null === t || t >= 0, o = Math.min(i[0], Ve()),
                            a = Math.min(i[1], Ve());
                    ...
                    }), Et("mainScrollAnimComplete", ai), Et("initialZoomInEnd", ai), Et("destroy", function () {
                        for (var t, e = 0; e < Ue.length; e++) (t = Ue[e]).container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                        Je = null
                    })
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? u.appendChild(l.html) : u.innerHTML = l.html), ri(l), ii(l, pt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (n = o.createEl("pswp__img", "img"), n.style.opacity = 1, n.src = l.src, si(l, n), ni(0, l, u, n)); else {
                            if (l.loadComplete = function (i) {
                                if (a) {
                                    if (t && t.index === e) {
                                        if (ri(i, !0)) return i.loadComplete = i.img = null, ii(i, pt), Dt(i), void(t.index === c && r.updateCurrZoomItem());
                                        i.imageAppended ? !Qe && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : M.transform && (nt || Qe) ? Je.push({
                                            item: i,
                                            baseDiv: u,
                                            img: i.img,
                                            index: e,
                                ...
                                l.msrc && (h.src = l.msrc), si(l, h), u.appendChild(h), l.placeholder = h
                            }
                            l.loading || oi(l), r.allowProgressiveImg() && (!Ze && M.transform ? Je.push({
                                item: l,
                                baseDiv: u,
                                img: l.img,
                                index: e,
                        ...
                        Ze || e !== c ? Dt(l) : (it = u.style, Ge(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(u)
                    } else t.el.innerHTML = ""
        ...
        Ct("Tap", {
            publicMethods: {
                initTap: function () {
                    ...
                    if (e && !X && !Z && !Yt) {
                        var i = e;
                        if (li && (clearTimeout(li), li = null, ye(i, ui))) return void St("doubleTap", i);
                        if ("mouse" === e.type) return void ci(t, e, "mouse");
                        if ("BUTTON" === t.target.tagName.toUpperCase() || o.hasClass(t.target, "pswp__single-tap")) return void ci(t, e);
        ...
        Ct("DesktopZoom", {
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    if (g <= r.currItem.fitRatio) return s.modal && (!s.closeOnScroll || Yt || U ? t.preventDefault() : k && Math.abs(t.deltaY) > 2 && (u = !0, r.close())), !0;
                    if (t.stopPropagation(), di.x = 0, "deltaX" in t) 1 === t.deltaMode ? (di.x = 18 * t.deltaX, di.y = 18 * t.deltaY) : (di.x = t.deltaX, di.y = t.deltaY); else if ("wheelDelta" in t) t.wheelDeltaX && (di.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? di.y = -.16 * t.wheelDeltaY : di.y = -.16 * t.wheelDelta; else {
                        if (!("detail" in t)) return;
                        di.y = t.detail
                    }
                    Wt(g, !0);
                    var e = ht.x - di.x, i = ht.y - di.y;
                    (s.modal || e <= et.min.x && e >= et.max.x && i <= et.min.y && i >= et.max.y) && t.preventDefault(), r.panTo(e, i)
                }, toggleDesktopZoom: function (e) {
                    e = e || {x: pt.x / 2 + mt.x, y: pt.y / 2 + mt.y};
                    var i = s.getDoubleTapZoom(!0, r.currItem), n = g === i;
                    r.mouseZoomedIn = !n, r.zoomTo(n ? r.currItem.initialZoomLevel : i, e, 333), o[(n ? "remove" : "add") + "Class"](t, "pswp--zoomed-in")
                }
            }
        });
        var hi, pi, fi, mi, gi, vi, yi, wi, bi, xi, Ci, Ti, _i = {history: !0, galleryUID: 1}, Ei = function () {
            ...
            if (s.galleryPIDs) {
                var r = e.pid;
                for (e.pid = 0, i = 0; i < Ue.length; i++) if (Ue[i].pid === r) {
                    e.pid = i;
                    break
                }
            ...
            if (fi && clearTimeout(fi), Yt || U) fi = setTimeout(ki, 500); else {
                ...
                Ti ? "#" + i !== window.location.hash && history[wi ? "replaceState" : "pushState"]("", document.title, n) : wi ? Ci.replace(n) : Ci.hash = i, wi = !0, pi = setTimeout(function () {
                    mi = !1
                }, 60)
            }
        };
            ...
            publicMethods: {
                initHistory: function () {
                    if (o.extend(s, _i, !0), s.history) {
                        Ci = window.location, xi = !1, bi = !1, wi = !1, yi = Ei(), Ti = "pushState" in history, yi.indexOf("gid=") > -1 && (yi = yi.split("&gid=")[0], yi = yi.split("?gid=")[0]), Et("afterChange", r.updateURL), Et("unbindEvents", function () {
                            o.unbind(window, "hashchange", r.onHashChange)
                        });
                        var t = function () {
                            vi = !0, bi || (xi ? history.back() : yi ? Ci.hash = yi : Ti ? history.pushState("", document.title, Ci.pathname + Ci.search) : Ci.hash = ""), Si()
                        };
                        Et("unbindEvents", function () {
                            u && t()
                        }), Et("destroy", function () {
                        ...
                        e > -1 && "&" === (yi = yi.substring(0, e)).slice(-1) && (yi = yi.slice(0, -1)), setTimeout(function () {
                            a && o.bind(window, "hashchange", r.onHashChange)
                        }, 40)
                    }
                }, onHashChange: function () {
                    return Ei() === yi ? (bi = !0, void r.close()) : void(mi || (gi = !0, r.goTo(Ii().pid), gi = !1))
                }, updateURL: function () {
    ...
    "use strict";
    return function (t, e) {
        var i, n, o, r, s, a, l, u, c, d, h, p, f, m, g, v, y, w, b, x = this, C = !1, T = !0, _ = !0, E = {
            ...
            for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", r = 0; r < B.length; r++) (i = B[r]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
            if (n) {
            ...
            return t.shout("shareLinkClick", e, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), _ || D(), 1))
        }, N = function () {
            for (var t, e, i, n, o, r = "", s = 0; s < g.shareButtons.length; s++) t = g.shareButtons[s], i = g.getImageURLForShare(t), n = g.getPageURLForShare(t), o = g.getTextForShare(t), e = t.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(i)).replace("{{raw_image_url}}", i).replace("{{text}}", encodeURIComponent(o)), r += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", g.parseShareButtonOut && (r = g.parseShareButtonOut(t, r));
            ...
            g.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()), i ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, "pswp--supports-fs")) : e.removeClass(t.template, "pswp--supports-fs"))
        }, R = function () {
            ...
            if (I()) {
                var s = g.barsSize;
                if (g.captionEl && "auto" === s.bottom) if (r || ((r = e.createEl("pswp__caption pswp__caption--fake")).appendChild(e.createEl("pswp__caption__center")), n.insertBefore(r, o), e.addClass(n, "pswp__ui--fit")), g.addCaptionHTMLFn(t, r, !0)) {
                    var a = r.clientHeight;
                    i.bottom = parseInt(a, 10) || 44
                } else i.bottom = s.top; else i.bottom = "auto" === s.bottom ? 0 : s.bottom;
                i.top = s.top
            } else i.top = i.bottom = 0
        }, H = function () {
            g.timeToIdle && d("mouseUsed", function () {
                e.bind(document, "mousemove", z), e.bind(document, "mouseout", M), w = setInterval(function () {
                    2 == ++P && x.setIdle(!0)
                }, g.timeToIdle / 2)
            })
        }, q = function () {
            ...
            var t, i, o, r = function (n) {
                if (n) for (var r = n.length, s = 0; s < r; s++) {
                    t = n[s], i = t.className;
                    for (var a = 0; a < B.length; a++) o = B[a], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                }
            };
            r(n.children);
        ...
        x.init = function () {
            e.extend(t.options, E, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen, q(), d("beforeChange", x.update), d("doubleTap", function (e) {
                ...
                e.bind(n, "pswpTap click", S), e.bind(t.scrollWrap, "pswpTap", x.onGlobalTap), t.likelyTouchDevice || e.bind(t.scrollWrap, "mouseover", x.onMouseOver)
            }), d("unbindEvents", function () {
                _ || D(), w && clearInterval(w), e.unbind(document, "mouseout", M), e.unbind(document, "mousemove", z), e.unbind(n, "pswpTap click", S), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
            }), d("destroy", function () {
            ...
            T && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), k(o, "caption--empty", !t.currItem.title)), C = !0) : C = !1, _ || D(), A()
            ...
            } else if (g.tapToToggleControls && (T ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || $(n))) return void t.close()
...
+function (t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var d = /top|bottom/.test(i), h = d ? 2 * c.left - o + l : 2 * c.top - r + u,
    ...
    e.prototype.add = function (t) {
        ...
        for (var r in t) {
            ...
            for (var a in this.waypoints[r]) {
                var l, u, c, d, h, p = this.waypoints[r][a], f = p.options.offset, m = p.triggerPoint, g = 0,
                    v = null == m;
